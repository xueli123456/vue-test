  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-form ref="listQuery" :inline="true" :model="listQuery">
        ...
        <el-form-item label="" prop="applicationStatus">
          <el-select v-model="listQuery.applicationStatus" filterable clearable placeholder="请选择预约状态" class="mc-input-col3">
            <el-option
        ...
        <el-form-item label="" prop="lineNo">
          <el-input v-model="listQuery.lineNo" class="filter-item" clearable placeholder="排队号" @keyup.enter.native="searchFilter" />
        </el-form-item>
        <div class="page-header">
          ...
          <el-button class="filter-item" type="primary" @click="viewTableInfo('2')">呼叫</el-button>
      ...
      <div class="dialog_auto_increase">
        <el-form ref="ruleForm1" :rules="rules" :model="ruleForm1" label-position="left" label-width="80px">
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="窗口" prop="execWindowsId">
                <el-select v-model="ruleForm1.execWindowsId" filterable clearable placeholder="请选择窗口">
                  <el-option
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="排队号" prop="lineNo">
                <el-input v-model="ruleForm1.lineNo" style="width: 205px;" clearable placeholder="排队号" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-button v-if="ruleForm1.queryFlag === '2'" type="primary" :disabled="callConcurrentControl" @click="call">呼叫</el-button>
          </el-row>
        </el-form>
        <div style="margin-top: 10px">
          <el-table v-loading.body="listLoading" :data="tableData1" stripe highlight-current-row element-loading-text="Loading" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="预约渠道" align="center" min-width="100" prop="reservationChannel">
              <template slot-scope="scope">
                <span>{{ scope.row.reservationChannel | channelFilter}}</span>
              </template>
            </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      resetForm(formName) {
        ...
        _this.txOfficeTimeList1 = []
        _this.ruleForm.reservationIds = []
        _this.ruleForm1.pageNum = 0
        _this.ruleForm1.pageSize = 20
        _this.$refs[formName].resetFields()
      },
      searchFilter() {
        const _this = this
      ...
      viewTableInfo(val) {
        ...
        if (_this.ruleForm.reservationIds.length > 0) {
          ...
          _this.ruleForm1.officeTimeIds = _this.listQuery.officeTimeIds
